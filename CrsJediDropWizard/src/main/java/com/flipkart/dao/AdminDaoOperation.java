...
public class AdminDaoOperation implements AdminDaoInterface{
	...
	public void removeCourse(String courseCode) throws CourseNotFoundException, CourseNotDeletedException{
		...
		try {
			...
			statement = conn.prepareStatement(SQLQueriesConstant.DELETE_COURSE_QUERY);
	...
	public Map<String, Object> getStudent(String studentId) {
		...
		statement = null;
		try {
			stmt = conn.prepareStatement(SQLQueriesConstant.GET_STUDENT_DETAILS);
        ...
        if (resultSet.next()) {
            ...
            resultMap.put("gradYear", gradYear);
